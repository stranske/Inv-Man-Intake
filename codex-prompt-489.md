...
- [x] add required ExtractedField.method plus optional structured SourceLocation and snippet metadata
- [x] populate methods/locations/snippets from primary providers, normalized multimodal output, threshold summary fields, and local run.json evidence
- [x] validate non-empty methods and structured locations, with focused contract and smoke coverage

### Acceptance Criteria
The PR is complete when ALL of these are satisfied:

- [x] python -m pytest tests/extraction/test_provider_contract_validation.py tests/extraction/test_pdf_primary_provider.py tests/extraction/test_pptx_primary_provider.py tests/extraction/test_thresholds.py tests/test_v1_acceptance_smoke.py -q --no-cov
- [x] python -m ruff check src/inv_man_intake/extraction/providers/base.py src/inv_man_intake/extraction/providers/pdf_primary.py src/inv_man_intake/extraction/providers/pptx_primary.py src/inv_man_intake/extraction/providers/primary.py src/inv_man_intake/extraction/providers/normalize.py src/inv_man_intake/extraction/confidence.py src/inv_man_intake/run.py tests/extraction/test_provider_contract_validation.py tests/extraction/test_thresholds.py tests/test_v1_acceptance_smoke.py
- [x] python -m ruff format --check src/inv_man_intake/extraction/providers/base.py src/inv_man_intake/extraction/providers/pdf_primary.py src/inv_man_intake/extraction/providers/pptx_primary.py src/inv_man_intake/extraction/providers/primary.py src/inv_man_intake/extraction/providers/normalize.py src/inv_man_intake/extraction/confidence.py src/inv_man_intake/run.py tests/extraction/test_provider_contract_validation.py tests/extraction/test_thresholds.py tests/test_v1_acceptance_smoke.py
- [x] python -m mypy src/inv_man_intake/extraction/providers/base.py src/inv_man_intake/extraction/providers/pdf_primary.py src/inv_man_intake/extraction/providers/pptx_primary.py src/inv_man_intake/extraction/providers/primary.py src/inv_man_intake/extraction/providers/normalize.py src/inv_man_intake/extraction/confidence.py src/inv_man_intake/run.py
