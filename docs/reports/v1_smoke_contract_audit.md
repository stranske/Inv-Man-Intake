...
| `provenance_history.source_location_trace` | `docs/contracts/provenance_history.md` | end-to-end | `tests/test_v1_acceptance_smoke.py:60-75` asserts source document and source page from extraction into the smoke result. | No issue filed; source-location trace is covered by #380 / PR #399. |
