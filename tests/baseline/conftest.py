"""Fixtures and catalog loading for the Inv-Man-Intake baseline kit."""
...
def base_submission() -> dict:
    """The base submission spec from the catalog (fresh copy per call upstream)."""
    return dict(load_catalog_cached()["base"])
