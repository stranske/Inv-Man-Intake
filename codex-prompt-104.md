...
verify:compare reported non-PASS output without a documented disposition for PR #57.

## Scope

Either document why concerns are not warranted or implement a bounded follow-up fix.
...
- [x] [#57](https://github.com/stranske/Inv-Man-Intake/issues/57)
- [ ] [#21](https://github.com/stranske/Inv-Man-Intake/issues/21)

### Acceptance Criteria
The PR is complete when ALL of these are satisfied:

- [x] Re-litigating checklist formatting.
